# ---------------------------------------------------------------------------- #
# Collection of utility function for binary classification                     #
# ---------------------------------------------------------------------------- #
...
def tokenize_reviews(review, tokenizer, max_length):
    # tokenize the text
    review = tokenizer(review["text"],
                        add_special_tokens = True,
                        max_length = max_length,
                        padding = 'max_length',
                        truncation = True
                    )
    # return tokenized review text
    return review
